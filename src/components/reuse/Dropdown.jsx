...
setarrow(true)
  ...
  return (<>
   ...
   <div className='bg-zinc-200 w-[25vh] h-[8vh] flex gap-[4vh] relative rounded-t items-center mr-2 ml-3  mt-[2%]' ><h1 className='font-semibold text-lg ml-[2vh]'>Category</h1>
